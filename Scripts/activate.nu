...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Dhaval\Programming\Anaconda\Spyder\ml_web_app'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Dhaval\Programming\Anaconda\Spyder\ml_web_app\Scripts\deactivate.nu'
